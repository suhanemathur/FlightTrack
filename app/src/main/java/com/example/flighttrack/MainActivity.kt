...
//latest code-additional fetures
...
//        val startingPointText = findViewById<TextView>(R.id.tvStartingPoint) // Added for start location
//        val buttonContainer = findViewById<LinearLayout>(R.id.buttonContainer) // For centering buttons
//
...
//                    }
//                    Log.e("WeatherAPI", "Error: $errorMessage")
//                    return@launch
//                }
//
...
//                }
//                Log.d("WeatherAPI", "Success: $temp°C, $description")
//
//            } catch (e: Exception) {
//                withContext(Dispatchers.Main) {
//                    weatherText.text = "Weather unavailable"
//                }
//                Log.e("WeatherAPI", "Exception: ${e.localizedMessage}")
//            }
//        }
//    }
//}

//CODE- has restart button
//package com.example.flighttrack
//
//import android.animation.ObjectAnimator
//import android.os.Bundle
...
//CODE- HAS FACTS AND RECOMENDATIONS
package com.example.flighttrack
